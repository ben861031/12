(function() {
    ...
    <div class="bg-white rounded-2xl border border-slate-200/90 shadow-2xs p-6 sm:p-8 space-y-6">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-slate-100">
        ...
        <div class="relative w-full md:w-80">
          <input type="text" id="announcementSearchInput" oninput="StudentPortal.handleAnnouncementSearch()" placeholder="\u641c\u5c0b\u516c\u544a\u6a19\u984c\u6216\u5167\u6587..." class="w-full pl-4 pr-10 py-2.5 rounded-xl border border-slate-200/90 text-sm font-medium focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-100 bg-slate-50/70 text-slate-800 transition-all placeholder:text-slate-400">
          <button type="button" id="announcementSearchClearBtn" onclick="StudentPortal.clearAnnouncementSearch()" class="hidden absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-slate-200/80 hover:bg-slate-300 text-slate-500 transition-all flex items-center justify-center cursor-pointer text-[11px] font-bold z-10">\u2715</button>
        </div>
      </div>
      <!-- \u5206\u985e\u6a19\u7c64\u5feb\u901f\u5207\u63db\u5668 (Category Filter Pills) -->
      <div class="flex items-center gap-2 overflow-x-auto pb-1 hide-scrollbar">
        <button onclick="StudentPortal.filterAnnouncementCategory('ALL')" data-ann-cat="ALL" class="ann-cat-pill active px-4 py-2 rounded-xl text-sm font-extrabold bg-blue-600 text-white shadow-2xs transition-all cursor-pointer whitespace-nowrap">\u5168\u90e8\u516c\u544a</button>
        <button onclick="StudentPortal.filterAnnouncementCategory('\u91cd\u8981\u901a\u77e5')" data-ann-cat="\u91cd\u8981\u901a\u77e5" class="ann-cat-pill px-4 py-2 rounded-xl text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all cursor-pointer whitespace-nowrap">\u91cd\u8981\u901a\u77e5</button>
        <button onclick="StudentPortal.filterAnnouncementCategory('\u88dc\u6e2c\u516c\u544a')" data-ann-cat="\u88dc\u6e2c\u516c\u544a" class="ann-cat-pill px-4 py-2 rounded-xl text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all cursor-pointer whitespace-nowrap">\u88dc\u6e2c\u516c\u544a</button>
        <button onclick="StudentPortal.filterAnnouncementCategory('\u7533\u8fa6\u63d0\u9192')" data-ann-cat="\u7533\u8fa6\u63d0\u9192" class="ann-cat-pill px-4 py-2 rounded-xl text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all cursor-pointer whitespace-nowrap">\u7533\u8fa6\u63d0\u9192</button>
        <button onclick="StudentPortal.filterAnnouncementCategory('\u8ab2\u7a0b\u8cc7\u8a0a')" data-ann-cat="\u8ab2\u7a0b\u8cc7\u8a0a" class="ann-cat-pill px-4 py-2 rounded-xl text-sm font-bold bg-slate-100 text-slate-700 hover:bg-slate-200 transition-all cursor-pointer whitespace-nowrap">\u8ab2\u7a0b\u8cc7\u8a0a</button>
      </div>
  ...
  <div id="adminPortalSection" class="hidden flex-1 flex flex-col md:flex-row min-h-[calc(100vh-61px)]">
    ...
    <aside class="corp-sidebar p-4 shrink-0">
      ...
      <div class="corp-sidebar-main">
        <div class="corp-sidebar-heading" aria-label="\u7ba1\u7406\u5f8c\u53f0\u54c1\u724c\u5340">
          <div class="corp-sidebar-brand-mark">
            <img src="assets/jinwen-logo.png" alt="\u666f\u6587\u79d1\u6280\u5927\u5b78\u6821\u5fbd">
          </div>
          <div class="min-w-0">
        ...
        <div class="corp-sidebar-navigation-panel">
        <nav class="corp-sidebar-nav space-y-1" aria-label="\u5f8c\u53f0\u4e3b\u8981\u529f\u80fd">
          <div class="corp-nav-section-label">\u65e5\u5e38\u4f5c\u696d</div>
          <!-- \u7368\u7acb\u3010\u5b78\u751f\u540d\u518a\u3011\u6309\u9215 -->
          ...
          <div class="corp-nav-section-label mt-2">\u7ba1\u7406\u5de5\u5177</div>
        ...
        <!-- \u8fd4\u56de\u5b78\u751f\u7aef\u6574\u5408\u65bc\u5c0e\u89bd\u5361\u5e95\u90e8\uff0c\u964d\u4f4e\u8996\u89ba\u6b0a\u91cd -->
        <div class="corp-sidebar-footer">
          <button onclick="App.switchTab('student')" class="corp-sidebar-student-link w-full font-bold py-2.5 rounded-xl text-sm transition-all flex items-center justify-center gap-2 active:scale-[0.98] cursor-pointer">
    ...
    <!-- \u53f3\u5074\u4e3b\u5de5\u4f5c\u5340 -->
    <main id="adminMainWorkspace" class="admin-data-table-workspace flex-1 px-4 sm:px-6 pt-2 sm:pt-3 pb-6 space-y-3 overflow-y-auto">
      <!-- \u624b\u6a5f\u7248\u5c08\u7528\u5f8c\u53f0\u9802\u6a13\u8cc7\u8a0a\u8207\u6377\u5f91\u5217 (\u50c5\u624b\u6a5f\u986f\u793a) -->
      <div class="md:hidden space-y-3 mb-2">
        <div class="mobile-admin-account relative">
          <button id="mobileAdminAccountMenuButton" type="button" onclick="AdminPortal.toggleMobileAccountMenu(event)" aria-expanded="false" aria-haspopup="menu" class="mobile-admin-account-trigger w-full bg-white border border-slate-200 rounded-2xl p-3 flex items-center gap-3 text-left shadow-sm active:bg-slate-50">
            <div class="w-10 h-10 rounded-xl bg-blue-50 text-blue-600 border border-blue-200 flex items-center justify-center shrink-0">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="8" r="4"/><path d="M5 20a7 7 0 0114 0v1H5v-1z"/></svg>
            </div>
            <div class="min-w-0 flex-1 leading-tight">
              <div class="flex items-center gap-2">
                <div id="mobileAdminName" class="min-w-0 flex-1 truncate font-extrabold text-slate-900 text-sm">\u7cfb\u7d71\u7ba1\u7406\u54e1</div>
                <span id="mobileAdminRoleBadge" class="inline-flex shrink-0 rounded-md bg-blue-50 px-2 py-0.5 text-[10px] font-bold text-blue-700">\u767b\u5165\u4e2d</span>
              </div>
            </div>
            <svg id="mobileAdminAccountChevron" class="w-4 h-4 text-slate-400 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
          </button>
          <div id="mobileAdminAccountDropdown" role="menu" class="mobile-admin-account-dropdown hidden absolute left-0 right-0 top-full z-50 mt-2 overflow-hidden rounded-2xl border border-slate-200 bg-white p-2 shadow-xl">
            <button type="button" role="menuitem" onclick="AdminPortal.closeAccountMenu(); AdminPortal.openSelfPasswordModal()" class="mobile-admin-menu-item text-slate-700">
              <span class="mobile-admin-menu-icon bg-slate-100 text-slate-600"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg></span>
              <span>\u4fee\u6539\u5bc6\u78bc</span>
            </button>
            <button type="button" role="menuitem" onclick="AdminPortal.closeAccountMenu(); App.switchTab('student')" class="mobile-admin-menu-item text-blue-700">
              <span class="mobile-admin-menu-icon bg-blue-50 text-blue-600"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/></svg></span>
              <span>\u8fd4\u56de\u5b78\u751f\u67e5\u8a62</span>
            </button>
            <button type="button" role="menuitem" onclick="AdminPortal.logout()" class="mobile-admin-menu-item group text-slate-700 hover:text-rose-700">
              <span class="mobile-admin-menu-icon bg-slate-100 text-slate-600 group-hover:bg-rose-50 group-hover:text-rose-600"><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"/></svg></span>
              <span>\u767b\u51fa\u7cfb\u7d71</span>
            </button>
          </div>
        </div>
        <div class="mobile-admin-tabs bg-white border border-slate-200 rounded-xl p-2 flex items-center gap-1.5 overflow-x-auto hide-scrollbar shadow-2xs" aria-label="\u5f8c\u53f0\u529f\u80fd\u5feb\u901f\u5207\u63db">
          ...
          <button data-admin-view="announcements" onclick="AdminPortal.switchView('announcements')" class="px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap bg-slate-50 text-slate-700">\u516c\u544a\u7ba1\u7406</button>
        </div>
      </div>
      <!-- \u8f15\u91cf\u9801\u9996\uff1a\u5716\u793a\u3001\u9801\u9762\u8cc7\u8a0a\u3001\u52d5\u4f5c\u6309\u9215\u8207\u5e33\u865f\u5165\u53e3\u4f7f\u7528\u540c\u4e00\u8996\u89ba\u5c64 -->
      <div class="admin-page-header-surface flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 !mt-0">
        <div class="admin-page-heading min-w-0 w-full sm:w-auto">
          <div id="adminPageHeaderIcon" class="admin-page-header-icon" aria-hidden="true">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg>
          </div>
          <div class="min-w-0">
            <h2 id="adminPageTitle" class="text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">\u5b78\u751f\u540d\u518a</h2>
            <p id="adminPageSubtitle" class="text-xs sm:text-sm font-semibold text-slate-400 mt-1">\u5171 0 \u7b46\u5b78\u751f\u8cc7\u6599</p>
          </div>
        </div>
        <div class="admin-header-right flex items-center justify-end gap-3 flex-wrap w-full sm:w-auto sm:shrink-0">
          <div id="adminHeaderActionGroup" class="flex items-center justify-end gap-2.5 flex-wrap w-full sm:w-auto">
          ...
          <div class="admin-header-divider hidden md:block h-8 w-px bg-slate-200" aria-hidden="true"></div>
          <div class="admin-account-menu hidden md:block relative shrink-0">
            <button id="adminAccountMenuButton" type="button" onclick="AdminPortal.toggleAccountMenu(event)" aria-expanded="false" aria-haspopup="menu" class="admin-account-trigger flex items-center gap-2.5 min-h-10 px-3 py-2 rounded-xl bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 shadow-2xs transition-all cursor-pointer">
              <span class="admin-account-trigger-avatar" aria-hidden="true">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M5 20a7 7 0 0114 0v1H5v-1z"/></svg>
              </span>
              <span id="desktopAdminName" class="max-w-32 truncate text-sm font-extrabold text-slate-800">\u672a\u767b\u5165</span>
              <svg id="adminAccountChevron" class="w-4 h-4 text-slate-400 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
            </button>
            <div id="adminAccountDropdown" role="menu" class="hidden absolute right-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl">
              <div class="border-b border-slate-100 bg-slate-50/80 px-4 py-3">
                <div class="flex items-center justify-between gap-3">
                  <div id="desktopAdminDropdownName" class="min-w-0 flex-1 truncate text-sm font-black text-slate-900">\u672a\u767b\u5165</div>
                  <span id="desktopAdminRoleBadge" class="inline-flex shrink-0 text-[11px] font-bold px-2 py-0.5 rounded-md bg-teal-100 text-teal-800">\u7cfb\u7d71\u7ba1\u7406\u54e1</span>
                </div>
              </div>
              <div class="p-2">
                <button type="button" role="menuitem" onclick="AdminPortal.closeAccountMenu(); AdminPortal.openSelfPasswordModal()" class="w-full rounded-xl px-3 py-2.5 text-left text-sm font-bold text-slate-700 hover:bg-slate-100 hover:text-slate-900 transition-colors flex items-center gap-2.5">
                  <svg class="w-4 h-4 text-slate-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                  <span>\u4fee\u6539\u5bc6\u78bc</span>
                </button>
                <button type="button" role="menuitem" onclick="AdminPortal.closeAccountMenu(); AdminPortal.logout()" class="group w-full rounded-xl px-3 py-2.5 text-left text-sm font-bold text-slate-700 hover:bg-rose-50 hover:text-rose-700 transition-colors flex items-center gap-2.5">
                  <svg class="w-4 h-4 text-slate-500 group-hover:text-rose-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013 3v1"/></svg>
                  <span>\u767b\u51fa\u7cfb\u7d71</span>
                </button>
              </div>
            </div>
      ...
      <div id="adminHeaderStatContainer" class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <!-- \u5361\u7247 1: \u7e3d\u5b78\u751f\u6578 -->
      ...
      <!-- ==================== \u6a21\u7d44 1: \u5b78\u751f\u540d\u518a ==================== -->
      <div id="erpView_roster" class="space-y-3">
              ...
              <thead>
                <tr>
                  <th class="w-[5%] text-center">
                    <input type="checkbox" id="thresholdSelectAll" onchange="AdminPortal.toggleThresholdPageSelection(this.checked)" class="w-4 h-4 rounded border-slate-300 cursor-pointer" title="\u9078\u53d6\u76ee\u524d\u9801\u9762">
                  </th>
      ...
      <!-- ==================== \u6a21\u7d44 2: \u9580\u6abb\u67e5\u8a62 ==================== -->
      <div id="erpView_threshold" class="hidden space-y-3">
        ...
        <div class="corp-card overflow-hidden">
          ...
          <div id="thresholdPagination" class="flex flex-wrap items-center justify-between gap-2 px-4 py-3 border-t border-slate-200 text-xs text-slate-500"></div>
        </div>
      </div>
      <!-- ==================== \u6a21\u7d44 3: \u500b\u4eba\u6210\u7e3e\u67e5\u8a62 ==================== -->
      <div id="erpView_dashboard" class="hidden space-y-3">
        <!-- \u641c\u5c0b\u5217 -->
        <div class="corp-card p-4">
          <div class="flex flex-col md:flex-row gap-3 items-end">
            <div class="flex-1 w-full">
              <label class="sr-only" for="individualSearchInput">\u8f38\u5165\u5b78\u865f\u6216\u59d3\u540d\u641c\u5c0b</label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
                </div>
                <input type="text" id="individualSearchInput" oninput="AdminPortal.handleInputClearBtn('individualSearchInput')" onkeyup="if(event.key === 'Enter') AdminPortal.searchIndividualRecord()" placeholder="\u8f38\u5165\u5b8c\u6574\u5b78\u865f\u6216\u59d3\u540d" class="w-full pl-11 pr-10 py-3 rounded-xl border border-slate-300 text-base font-medium focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm transition-all">
        ...
        <!-- \u67e5\u8a62\u7d50\u679c\u5340 (\u9810\u8a2d\u96b1\u85cf) -->
        <div id="individualSearchResultArea" class="hidden space-y-3">
          <!-- \u500b\u4eba\u8cc7\u8a0a\u5361\u7247 -->
          <div class="corp-card p-4 sm:p-5 bg-white border border-slate-200 shadow-sm">
            <div class="grid grid-cols-1 lg:grid-cols-[minmax(210px,0.95fr)_minmax(0,3.05fr)] gap-4">
              <!-- \u5de6\u5074\uff1a\u57fa\u672c\u8cc7\u6599 -->
              <div class="min-h-[132px] lg:border-r border-slate-200 px-3 lg:px-5 py-3 flex flex-col justify-center">
                <div class="min-w-0">
                  <div class="flex flex-wrap items-center gap-2 mb-3.5">
                    <h2 id="indivProfileName" class="text-[24px] font-black text-slate-900 tracking-tight leading-none">\u59d3\u540d</h2>
                  <span id="indivProfileEnrollStatus" class="px-2 py-1 rounded-full text-xs font-bold leading-none bg-blue-50 text-blue-600 border border-blue-200">\u5728\u5b78</span>
                  </div>
                  <div class="border-t border-slate-200 pt-3.5 space-y-1.5 text-sm text-slate-600 font-semibold">
                    <div><span id="indivProfileId" class="font-mono">\u5b78\u865f</span></div>
                    <div><span id="indivProfileClass">\u73ed\u7d1a</span></div>
                  </div>
                </div>
              </div>
              <!-- \u53f3\u5074\uff1a\u56db\u9805\u9ad4\u9069\u80fd\u6458\u8981 -->
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1fr_1.12fr_1fr] gap-3">
                <div class="min-h-[132px] rounded-2xl bg-blue-50/35 border border-blue-100 px-3 py-4 flex flex-col items-center justify-center text-center">
                  <div class="text-[15px] font-bold text-slate-600 mb-4 leading-tight">\u7d2f\u8a08\u53ca\u683c\u6b21\u6578</div>
                  <div id="indivProfilePassCount" class="text-[36px] font-black text-blue-600 font-mono leading-none">0</div>
                </div>
                <div class="min-h-[132px] rounded-2xl bg-emerald-50/35 border border-emerald-100 px-3 py-4 flex flex-col items-center justify-center text-center">
                  <div class="text-[15px] font-bold text-slate-600 mb-4 leading-tight">\u5269\u9918\u9700\u88dc\u6b21\u6578</div>
                  <div id="indivProfileDeficit" class="text-[36px] font-black text-emerald-600 font-mono leading-none">2</div>
                </div>
                <div id="indivProfileStatusPanel" class="min-h-[132px] rounded-2xl bg-emerald-50/60 border border-emerald-200 px-3 py-4 flex flex-col items-center justify-center text-center">
                  <div class="text-[15px] font-bold text-slate-600 leading-tight">\u9ad4\u9069\u80fd\u7562\u696d\u9580\u6abb</div>
                  <div class="mt-4 inline-flex items-center gap-2 rounded-full bg-white/75 border border-emerald-200 px-4 py-2 shadow-sm">
                    <div id="indivProfileStatusIcon" class="w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center shrink-0" aria-hidden="true">
                      <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                    </div>
                    <div id="indivProfileStatus" class="text-[28px] font-black text-emerald-700 tracking-tight leading-none">\u901a\u904e</div>
                  </div>
                </div>
                <div id="indivProfileSpecialCard" class="min-h-[132px] rounded-2xl bg-amber-50/55 border border-amber-100 px-3 py-4 flex flex-col items-center justify-center text-center">
                  <div class="text-[15px] font-bold text-slate-600 leading-tight">\u7279\u6b8a\u8eab\u5206</div>
                  <div id="indivProfileSpecial" class="mt-4 flex flex-col items-center leading-none">
                    <span class="text-[30px] font-black text-amber-700">\u514d\u6e2c</span>
                    <span class="text-[13px] font-semibold text-amber-700 mt-2">\u9ad4\u4fdd\uff0f\u8eab\u969c</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- \u7a7a\u72c0\u614b\u63d0\u793a -->
        <div id="individualSearchEmpty" class="hidden corp-card p-10 sm:p-12 text-center border border-dashed border-slate-300">
          <div class="w-14 h-14 rounded-2xl bg-slate-100 text-slate-400 mx-auto mb-4 flex items-center justify-center">
      ...
      <!-- ==================== \u6a21\u7d44 4: \u6aa2\u6e2c\u8cc7\u6599\u7ba1\u7406 ==================== -->
      <div id="erpView_records" class="hidden space-y-3">
        <div class="bg-[#f8fafc] border border-slate-200/90 rounded-2xl p-3 shadow-2xs">
          <div class="flex flex-wrap items-center gap-3">
            <div class="relative flex-1 min-w-[260px]">
              <svg class="w-4 h-4 text-slate-400 absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
              <input type="text" id="recordsSearchInput" oninput="AdminPortal.handleInputClearBtn('recordsSearchInput'); AdminPortal.resetRecordsPageAndRender()" placeholder="\u641c\u5c0b\u5b78\u751f\u59d3\u540d / \u5b78\u865f..." class="w-full pl-10 pr-9 py-2.5 bg-white rounded-xl border border-slate-200 text-sm font-medium focus:border-blue-600 focus:outline-none placeholder:text-slate-400 shadow-2xs">
              <button type="button" id="recordsSearchInputClearBtn" onclick="AdminPortal.clearSearchInput('recordsSearchInput')" class="hidden absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-slate-200/80 hover:bg-slate-300 text-slate-500 hover:text-slate-700 transition-all flex items-center justify-center cursor-pointer text-xs font-bold shrink-0 z-10" title="\u6e05\u9664\u641c\u5c0b\u5167\u5bb9">\u2715</button>
            </div>
            <select id="recordsSemesterFilter" onchange="AdminPortal.resetRecordsPageAndRender()" class="bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm font-semibold text-slate-700 focus:border-blue-600 focus:outline-none shadow-2xs min-w-[175px]">
              <option value="">\u9078\u64c7\u5b78\u671f</option>
              <option value="all">\u6240\u6709\u5b78\u671f\uff08\u8f03\u6162\uff09</option>
            </select>
            <select id="recordsResultFilter" onchange="AdminPortal.resetRecordsPageAndRender()" class="bg-white border border-slate-200 rounded-xl px-3.5 py-2.5 text-sm font-semibold text-slate-700 focus:border-blue-600 focus:outline-none shadow-2xs min-w-[125px]">
              <option value="">\u5168\u90e8\u7d50\u679c</option>
              <option value="\u5408\u683c">\u5408\u683c</option>
              <option value="\u4e0d\u5408\u683c">\u4e0d\u5408\u683c</option>
              <option value="\u514d\u6e2c">\u514d\u6e2c</option>
            </select>
            <button type="button" onclick="AdminPortal.clearRecordsFilters()" class="bg-white hover:bg-slate-50 text-slate-600 border border-slate-200 px-3.5 py-2.5 rounded-xl text-sm font-semibold shadow-2xs transition-colors flex items-center gap-1.5 cursor-pointer shrink-0" title="\u6062\u5fa9\u6700\u65b0\u5b78\u671f\u4e26\u6e05\u9664\u5176\u4ed6\u7be9\u9078">
        ...
        <div class="corp-card overflow-hidden">
          ...
          <div id="recordsPagination" class="flex flex-wrap items-center justify-between gap-2 px-4 py-3 border-t border-slate-200 text-xs text-slate-500"></div>
        </div>
      </div>
      <!-- ==================== \u6a21\u7d44 5: \u73ed\u7d1a\u7d71\u8a08 ==================== -->
      ...
      <div id="erpView_risk" class="hidden corp-card p-6">
        <div class="flex flex-col md:flex-row gap-3 mb-4">
          <div class="flex-1 relative">
            <input type="text" id="riskSearchInput" placeholder="\u641c\u5c0b\u5b78\u865f\u3001\u59d3\u540d\u6216\u73ed\u7d1a..." oninput="AdminPortal.handleInputClearBtn('riskSearchInput')" onkeyup="AdminPortal.resetRiskPageAndRender()" class="w-full pl-4 pr-9 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400">
          ...
          <div class="w-full md:w-32">
            <select id="riskEnrollYearFilter" onchange="AdminPortal.resetRiskPageAndRender()" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-400 cursor-pointer">
              <option value="">\u6240\u6709\u5e74\u7d1a</option>
            </select>
          </div>
          <div class="w-full md:w-40">
            <select id="riskClassFilter" onchange="AdminPortal.resetRiskPageAndRender()" class="w-full px-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-400 cursor-pointer">
        ...
        <div class="corp-table-container max-h-[calc(100vh-220px)] sm:max-h-[calc(100vh-240px)] overflow-y-auto">
          <table class="corp-table">
            <thead>
              <tr>
                <th class="w-[5%] text-center">
                  <input type="checkbox" id="riskSelectAll" onchange="AdminPortal.toggleAllRiskSelection(this.checked)" class="w-4 h-4 rounded text-blue-600 border-slate-300 cursor-pointer" title="\u9078\u53d6\u76ee\u524d\u9801\u9762">
                </th>
                <th class="w-[15%]">\u73ed\u7d1a</th>
                <th class="w-[15%]">\u5b78\u865f</th>
                <th class="w-[15%]">\u59d3\u540d</th>
        ...
        <div id="riskPagination" class="flex flex-wrap items-center justify-between gap-2 pt-3 mt-3 border-t border-slate-200 text-xs text-slate-500"></div>
      </div>
      <!-- ==================== \u6a21\u7d44 7: \u64cd\u4f5c\u7d00\u9304 ==================== -->
      <div id="erpView_logs" class="hidden corp-card p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
          <p class="text-xs leading-5 text-slate-500">\u8a18\u9304\u767b\u5165\uff0f\u767b\u51fa\u3001\u8cc7\u6599\u7570\u52d5\u3001\u6279\u6b21\u4f5c\u696d\u3001Excel \u532f\u5165\u3001\u516c\u544a\u3001\u5e33\u865f\u8207\u96f2\u7aef\u540c\u6b65\u7b49\u91cd\u8981\u64cd\u4f5c\uff1b\u7d14\u67e5\u8a62\u3001\u7be9\u9078\u3001\u63db\u9801\u8207\u532f\u51fa\u4e0d\u6703\u5beb\u5165\u7d00\u9304\u3002</p>
          <span id="auditLogCount" class="shrink-0 text-xs font-bold text-slate-500">\u5171 0 \u7b46</span>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-[minmax(220px,1.5fr)_minmax(150px,1fr)_minmax(160px,1fr)_130px_150px_150px_auto] gap-2.5 mb-4">
          <div class="relative">
            ...
            <input id="auditSearchInput" type="text" oninput="AdminPortal.renderAuditLogs()" placeholder="\u641c\u5c0b\u64cd\u4f5c\u4eba\u3001\u5e33\u865f\u3001\u52d5\u4f5c\u6216\u5167\u5bb9" class="w-full pl-9 pr-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm focus:bg-white focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400">
          </div>
          <select id="auditOperatorFilter" onchange="AdminPortal.renderAuditLogs()" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm font-semibold text-slate-700 focus:bg-white focus:outline-none focus:border-blue-400">
            <option value="">\u6240\u6709\u64cd\u4f5c\u4eba</option>
          </select>
          <select id="auditActionFilter" onchange="AdminPortal.renderAuditLogs()" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm font-semibold text-slate-700 focus:bg-white focus:outline-none focus:border-blue-400">
            <option value="">\u6240\u6709\u52d5\u4f5c</option>
          </select>
          <select id="auditResultFilter" onchange="AdminPortal.renderAuditLogs()" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm font-semibold text-slate-700 focus:bg-white focus:outline-none focus:border-blue-400">
            <option value="">\u6240\u6709\u7d50\u679c</option>
            <option value="success">\u6210\u529f</option>
            <option value="failure">\u5931\u6557</option>
          </select>
          <label class="relative block">
            <span class="sr-only">\u958b\u59cb\u65e5\u671f</span>
            <input id="auditDateFrom" type="date" onchange="AdminPortal.renderAuditLogs()" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-700 focus:bg-white focus:outline-none focus:border-blue-400" title="\u958b\u59cb\u65e5\u671f">
          </label>
          <label class="relative block">
            <span class="sr-only">\u7d50\u675f\u65e5\u671f</span>
            <input id="auditDateTo" type="date" onchange="AdminPortal.renderAuditLogs()" class="w-full px-3 py-2.5 rounded-xl border border-slate-200 bg-slate-50 text-sm text-slate-700 focus:bg-white focus:outline-none focus:border-blue-400" title="\u7d50\u675f\u65e5\u671f">
          </label>
          <button type="button" onclick="AdminPortal.resetAuditFilters()" class="sm:col-span-2 xl:col-span-1 px-3.5 py-2.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 text-sm font-bold text-slate-600 whitespace-nowrap">\u6e05\u9664\u7be9\u9078</button>
        </div>
        <div class="corp-table-container max-h-[calc(100vh-210px)] sm:max-h-[calc(100vh-230px)] overflow-y-auto">
          <table class="corp-table min-w-[920px]">
            <thead>
              <tr>
                <th class="w-[17%]">\u6642\u9593</th>
                <th class="w-[14%]">\u64cd\u4f5c\u4eba</th>
                <th class="w-[18%]">\u52d5\u4f5c</th>
                <th class="w-[9%] text-center">\u7d50\u679c</th>
                <th class="w-[34%]">\u5167\u5bb9\u6458\u8981</th>
                <th class="w-[8%] text-center">\u660e\u7d30</th>
              </tr>
            </thead>
      ...
      <!-- ==================== \u6a21\u7d44 8: \u7cfb\u7d71\u8a2d\u5b9a ==================== -->
      <div id="erpView_settings" class="hidden space-y-3">
        <!-- \u5340\u584a 1: \u96f2\u7aef\u540c\u6b65\u8207\u5099\u4efd\u4e2d\u5fc3 (Firebase Dual-Sync Center) -->
        <div class="settings-section-heading">
          <span class="settings-section-number">1</span>
          <div><h3>Firebase \u96f2\u7aef\u8cc7\u6599</h3><p>\u624b\u52d5\u63a8\u64ad\u3001\u62c9\u53d6\u8207\u8de8\u700f\u89bd\u5668\u8cc7\u6599\u540c\u6b65</p></div>
        </div>
        ...
        <!-- \u5340\u584a 2: \u5e33\u865f\u8207\u6b0a\u9650\u7ba1\u7406\uff08\u500b\u4eba\u5bc6\u78bc\u7d71\u4e00\u7531\u5de6\u5074\u5165\u53e3\u4fee\u6539\uff09 -->
        <div class="space-y-3">
          <div class="settings-section-heading">
            <span class="settings-section-number">2</span>
            <div><h3>\u5e33\u865f\u8207\u6b0a\u9650\u7ba1\u7406</h3><p>\u96c6\u4e2d\u7ba1\u7406\u59d3\u540d\u3001\u767b\u5165\u5e33\u865f\u3001\u89d2\u8272\u3001\u72c0\u614b\u53ca\u7ba1\u7406\u8005\u91cd\u8a2d\u5bc6\u78bc</p></div>
          </div>
        ...
        <div class="space-y-3">
          <div class="settings-section-heading">
            ...
            <div><h3>\u8cc7\u6599\u7dad\u8b77</h3><p>\u91cd\u65b0\u8a08\u7b97\u9580\u6abb\uff0c\u6216\u8655\u7406\u532f\u5165\u932f\u8aa4\u7684\u7279\u5b9a\u5b78\u671f\u8cc7\u6599</p></div>
          </div>
        ...
        <div class="settings-section-heading settings-section-heading-danger">
          <span class="settings-section-number">4</span>
          <div><h3>\u5371\u96aa\u64cd\u4f5c</h3><p>\u4e0d\u53ef\u5fa9\u539f\u7684\u5168\u6821\u8cc7\u6599\u6e05\u9664\u529f\u80fd</p></div>
        </div>
      ...
      <!-- ==================== \u6a21\u7d44 9: \u516c\u544a\u7ba1\u7406 ==================== -->
      <div id="erpView_announcements" class="hidden corp-card p-6 space-y-4">
        <div class="pb-3 border-b border-slate-100">
          <p class="text-sm text-slate-600">\u8a2d\u5b9a\u5b78\u751f\u524d\u53f0\u986f\u793a\u5167\u5bb9\uff0c\u652f\u63f4\u7f6e\u9802\u53ca\u520a\u767b\u8d77\u8a16\u6642\u9593\uff0c\u903e\u671f\u5f8c\u81ea\u52d5\u96b1\u85cf\u3002</p>
        </div>
        <div class="corp-table-container max-h-[60vh] overflow-y-auto">
          <table class="corp-table">
            <thead>
  ...
  <!-- \u64cd\u4f5c\u7d00\u9304\u5b8c\u6574\u660e\u7d30 Modal -->
  <div id="auditLogDetailModal" role="dialog" aria-modal="true" aria-labelledby="auditLogDetailTitle" class="fixed inset-0 z-[70] bg-slate-900/45 backdrop-blur-sm hidden items-center justify-center p-4">
    <div class="w-full max-w-2xl rounded-2xl border border-slate-200 bg-white shadow-2xl overflow-hidden">
      <div class="flex items-center justify-between gap-4 px-5 py-4 border-b border-slate-100 bg-slate-50/80">
        <div>
          <h3 id="auditLogDetailTitle" class="text-lg font-black text-slate-900">\u64cd\u4f5c\u7d00\u9304\u660e\u7d30</h3>
          <p id="auditDetailTimestamp" class="mt-1 text-xs font-mono text-slate-500">-</p>
        </div>
        <button type="button" onclick="AdminPortal.closeAuditLogDetail()" class="w-9 h-9 rounded-xl text-slate-400 hover:text-slate-700 hover:bg-slate-200/70 text-xl font-bold" aria-label="\u95dc\u9589\u64cd\u4f5c\u7d00\u9304\u660e\u7d30">\u2715</button>
      </div>
      <div class="p-5 grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
        <div class="rounded-xl bg-slate-50 border border-slate-100 p-3"><div class="text-xs font-bold text-slate-400 mb-1">\u64cd\u4f5c\u4eba</div><div id="auditDetailOperator" class="font-bold text-slate-800">-</div></div>
        <div class="rounded-xl bg-slate-50 border border-slate-100 p-3"><div class="text-xs font-bold text-slate-400 mb-1">\u767b\u5165\u5e33\u865f\uff0f\u89d2\u8272</div><div id="auditDetailAccount" class="font-semibold text-slate-700">-</div></div>
        <div class="rounded-xl bg-slate-50 border border-slate-100 p-3"><div class="text-xs font-bold text-slate-400 mb-1">\u52d5\u4f5c</div><div id="auditDetailAction" class="font-bold text-slate-800">-</div></div>
        <div class="rounded-xl bg-slate-50 border border-slate-100 p-3"><div class="text-xs font-bold text-slate-400 mb-1">\u57f7\u884c\u7d50\u679c</div><div id="auditDetailResult" class="font-bold text-slate-800">-</div></div>
        <div class="sm:col-span-2 rounded-xl bg-slate-50 border border-slate-100 p-3"><div class="text-xs font-bold text-slate-400 mb-1">\u5b78\u751f\u5b78\u865f\uff0f\u8cc7\u6599\u8b58\u5225</div><div id="auditDetailStudentId" class="font-mono font-semibold text-slate-700">-</div></div>
        <div class="sm:col-span-2 rounded-xl bg-slate-50 border border-slate-100 p-4"><div class="text-xs font-bold text-slate-400 mb-2">\u5b8c\u6574\u5167\u5bb9</div><div id="auditDetailContent" class="text-slate-700 leading-6 whitespace-pre-wrap break-words">-</div></div>
      </div>
    </div>
  </div>
  <!-- ==================== \u6d6e\u52d5 Dock \u5de5\u5177\u5217 ==================== -->
  ...
  <div id="rosterEditModal" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 hidden">
    <div class="corp-card max-w-2xl w-full max-h-[92vh] overflow-y-auto p-5 sm:p-6 shadow-2xl bg-white rounded-2xl border border-slate-200">
      ...
      <div class="space-y-4 text-sm">
        ...
        <section class="rounded-2xl border border-blue-200/80 bg-blue-50/50 p-4">
          <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h4 class="font-black text-slate-900">\u6b77\u53f2\u8cc7\u6599\u627f\u63a5</h4>
              <p class="mt-1 text-xs leading-5 text-slate-600">\u5b78\u751f\u9000\u5b78\u5f8c\u4ee5\u65b0\u5b78\u865f\u518d\u6b21\u5165\u5b78\u6642\uff0c\u53ef\u7531\u6821\u65b9\u6838\u51c6\u627f\u63a5\u6307\u5b9a\u820a\u5b78\u671f\uff1b\u539f\u59cb\u6210\u7e3e\u4e0d\u6703\u6539\u5beb\u3002</p>
            </div>
            <button type="button" onclick="AdminPortal.openRecordCarryoverModal()" class="shrink-0 rounded-xl bg-blue-600 px-3.5 py-2 text-xs font-bold text-white shadow-xs transition-colors hover:bg-blue-700">
              \u627f\u63a5\u820a\u5b78\u865f\u8cc7\u6599
            </button>
          </div>
          <div id="rosterCarryoverSummary" class="mt-3 space-y-2.5"></div>
        </section>
  ...
  <!-- \u820a\u5b78\u865f\u6b77\u53f2\u8cc7\u6599\u627f\u63a5 Modal -->
  <div id="recordCarryoverModal" role="dialog" aria-modal="true" aria-labelledby="recordCarryoverTitle" class="fixed inset-0 z-[60] hidden flex items-center justify-center bg-slate-900/50 p-4 backdrop-blur-sm">
    <div class="w-full max-w-2xl max-h-[92vh] overflow-y-auto rounded-2xl border border-slate-200 bg-white p-5 shadow-2xl sm:p-6">
      <div class="mb-5 flex items-start justify-between gap-4 border-b border-slate-200 pb-4">
        <div>
          <h3 id="recordCarryoverTitle" class="text-lg font-black text-slate-900">\u627f\u63a5\u820a\u5b78\u865f\u8cc7\u6599</h3>
          <p class="mt-1 text-xs leading-5 text-slate-500">\u76ee\u524d\u5b78\u751f\uff1a<span id="carryoverTargetStudent" class="font-bold text-slate-700">-</span></p>
        </div>
        <button type="button" onclick="AdminPortal.closeRecordCarryoverModal()" aria-label="\u95dc\u9589" class="text-2xl font-bold text-slate-400 hover:text-slate-600">\u2715</button>
      </div>
      <div class="space-y-4 text-sm">
        <div class="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs font-semibold leading-5 text-amber-900">
          \u50c5\u9650\u7d93\u6821\u65b9\u78ba\u8a8d\u70ba\u540c\u4e00\u4eba\u7684\u65b0\u820a\u5b78\u865f\u4f7f\u7528\u3002\u627f\u63a5\u5f8c\u820a\u5b78\u865f\u505c\u6b62\u524d\u53f0\u67e5\u8a62\uff0c\u5f8c\u53f0\u539f\u59cb\u540d\u518a\u8207\u6210\u7e3e\u4ecd\u5b8c\u6574\u4fdd\u7559\u3002
        </div>
        <div>
          <label for="carryoverSourceStudentId" class="mb-1.5 block font-bold text-slate-700">\u820a\u5b78\u865f</label>
          <div class="flex gap-2">
            <input id="carryoverSourceStudentId" type="text" inputmode="numeric" autocomplete="off" placeholder="\u8f38\u5165\u820a\u5b78\u865f" onkeydown="if(event.key==='Enter'){event.preventDefault();AdminPortal.loadCarryoverSourcePreview()}" class="min-w-0 flex-1 rounded-xl border border-slate-300 px-4 py-2.5 font-mono font-bold text-slate-900 focus:border-blue-500 focus:outline-none">
            <button type="button" onclick="AdminPortal.loadCarryoverSourcePreview()" class="rounded-xl border border-blue-200 bg-blue-50 px-4 py-2.5 font-bold text-blue-700 transition-colors hover:bg-blue-100">\u8f09\u5165\u8cc7\u6599</button>
          </div>
        </div>
        <div id="carryoverSourcePreview" class="hidden space-y-4">
          <div id="carryoverSourceSummary" class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3"></div>
          <div id="carryoverNameMismatchNotice" class="hidden rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-xs leading-5 text-rose-800">
            <div class="font-black">\u65b0\u820a\u540d\u518a\u59d3\u540d\u4e0d\u4e00\u81f4</div>
            <label class="mt-2 flex cursor-pointer items-start gap-2 font-semibold">
              <input id="carryoverNameMismatchConfirm" type="checkbox" onchange="AdminPortal.updateCarryoverConfirmState()" class="mt-0.5 h-4 w-4 rounded border-rose-300 text-rose-600">
              <span>\u6211\u5df2\u4f9d\u6821\u65b9\u6587\u4ef6\u78ba\u8a8d\u70ba\u540c\u4e00\u4f4d\u5b78\u751f\uff0c\u4ecd\u8981\u9032\u884c\u627f\u63a5\u3002</span>
            </label>
          </div>
          <div>
            <div class="mb-2 flex items-center justify-between gap-3">
              <label class="font-bold text-slate-700">\u9078\u64c7\u627f\u63a5\u5b78\u671f</label>
              <span class="text-[11px] font-semibold text-slate-400">\u540c\u5b78\u671f\u5df2\u6709\u65b0\u8cc7\u6599\u6642\u4e0d\u53ef\u91cd\u8907\u627f\u63a5</span>
            </div>
            <div id="carryoverSemesterOptions" class="grid grid-cols-1 gap-2 sm:grid-cols-2"></div>
          </div>
          <div>
            <label for="carryoverApprovalNote" class="mb-1.5 block font-bold text-slate-700">\u6821\u65b9\u6838\u51c6\u4f9d\u64da\uff0f\u5167\u90e8\u5099\u8a3b <span class="text-rose-500">*</span></label>
            <textarea id="carryoverApprovalNote" rows="3" oninput="AdminPortal.updateCarryoverConfirmState()" placeholder="\u4f8b\u5982\uff1a\u4f9d 2026/08/27 \u9ad4\u80b2\u7d44\u7c3d\u6838\uff0c\u540c\u610f\u627f\u63a5\u820a\u5b78\u865f\u6b77\u5e74\u9ad4\u9069\u80fd\u7d00\u9304\u3002" class="w-full resize-none rounded-xl border border-slate-300 px-4 py-3 text-sm leading-6 text-slate-900 focus:border-blue-500 focus:outline-none"></textarea>
          </div>
        </div>
        <div class="flex gap-3 border-t border-slate-200 pt-4">
          <button type="button" onclick="AdminPortal.closeRecordCarryoverModal()" class="flex-1 rounded-xl bg-slate-100 py-2.5 text-sm font-bold text-slate-700 hover:bg-slate-200">\u53d6\u6d88</button>
          <button id="confirmCarryoverButton" type="button" onclick="AdminPortal.confirmRecordCarryover()" disabled class="flex-1 rounded-xl bg-blue-600 py-2.5 text-sm font-bold text-white shadow-xs transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:bg-slate-300">\u78ba\u8a8d\u627f\u63a5</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="max-w-[420px] w-full p-8 sm:p-9 bg-white rounded-3xl text-center shadow-2xl border border-slate-100/80">
      ...
      <div class="space-y-4 mb-6 text-left">
        <div class="relative">
            ...
            <input type="text" id="adminAccountInput" autocomplete="username" aria-label="\u5e33\u865f" placeholder="\u5e33\u865f" class="w-full pl-11 pr-4 py-3 rounded-2xl border border-slate-200 bg-slate-50/40 text-sm font-semibold text-slate-900 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 focus:bg-white focus:outline-none transition-colors placeholder:text-slate-400 placeholder:font-normal">
        </div>
        <div class="relative">
            ...
            <input type="password" id="adminPasswordInput" autocomplete="current-password" aria-label="\u5bc6\u78bc" placeholder="\u5bc6\u78bc" class="w-full pl-11 pr-11 py-3 rounded-2xl border border-slate-200 bg-slate-50/40 text-sm font-semibold text-slate-900 focus:border-emerald-600 focus:ring-1 focus:ring-emerald-600 focus:bg-white focus:outline-none transition-colors placeholder:text-slate-400 placeholder:font-normal">
      ...
      <!-- \u6b21\u8981\u8fd4\u56de\u5165\u53e3\uff1a\u4fdd\u7559\u529f\u80fd\u4f46\u964d\u4f4e\u8996\u89ba\u5c64\u7d1a -->
      <button onclick="AdminPortal.hideLoginModal(); App.switchTab('student');" class="mt-4 w-full bg-white hover:bg-slate-50 text-slate-500 hover:text-slate-700 border border-slate-200 font-semibold py-2.5 rounded-xl text-sm transition-colors flex items-center justify-center gap-2 cursor-pointer">
  ...
  <div id="announcementEditModal" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4 hidden">
    <div class="corp-card max-w-lg w-full p-6 bg-white rounded-2xl border border-slate-200 shadow-xl">
      <div class="flex justify-between items-center pb-3 border-b border-slate-100 mb-4">
        <h3 id="announcementModalHeader" class="font-bold text-slate-900 text-base">\u65b0\u589e\u516c\u544a</h3>
